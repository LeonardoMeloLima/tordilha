...
export const PaisAvisos = () => {
  ...
  const filteredAvisos = avisos.filter(a =>
    !a.target_role || a.target_role === 'geral' || a.target_role === 'pais'
  );
  ...
  return (
    <div className="space-y-6 animate-fade-in pb-24">
      <div>
        ...
        <p className="text-sm text-muted-foreground font-medium mt-0.5">{filteredAvisos.length} avisos importantes</p>
      </div>
