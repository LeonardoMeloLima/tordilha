  ...
  return (
    <div className="space-y-6 animate-fade-in pb-24">
      ...
      <div className="space-y-8">
        {cavalos.map((cavalo) => (
          <div key={cavalo.id} className="bg-card rounded-[40px] card-shadow overflow-hidden group border-2 border-transparent hover:border-amber-50 transition-all">
              ...
              <div className="grid grid-cols-3 gap-4">
                <div className="flex flex-col items-center gap-2 p-5 rounded-3xl bg-emerald-50 border border-emerald-100 transition-transform hover:scale-105">
                  ...
                  <div className="flex flex-col items-center">
                    <span className="text-xs font-black text-slate-900 uppercase tracking-tight">{cavalo.status || "Ativo"}</span>
                ...
                <div className="flex flex-col items-center gap-2 p-5 rounded-3xl bg-amber-50 border border-amber-100 transition-transform hover:scale-105">
                  ...
                  <div className="flex flex-col items-center">
                    <span className="text-xs font-black text-slate-900 uppercase tracking-tight">{cavalo.humor || "Dócil"}</span>
