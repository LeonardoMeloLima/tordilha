// src/components/professor/ProfessorPendencias.tsx
//
// "Minhas pendências" do terapeuta. Estrutura clonada de GestorPendencias —
// MAS a regra de quem pode decidir é INVERSA: o terapeuta decide todas as
// solicitações bilaterais (mudanca_recorrencia, remarcacao_sessao,
// nova_recorrencia) e apenas observa `novo_cadastro` (que é incumbência
// exclusiva do gestor).
...
export function ProfessorPendencias() {
  ...
  // RLS já filtra: o terapeuta só enxerga solicitações dos seus praticantes.
  ...
  // Banner: pendências paradas (sem decisão > 3 dias). Não filtra tipo —
  // o terapeuta vê só as próprias mesmo (RLS).
        ...
        <div className="bg-red-50 border-l-4 border-red-500 p-3 rounded-r-md flex gap-3 items-start">
          ...
          <div>
            ...
            <p className="text-xs text-red-700 mt-0.5">
              Verifique com o responsável ou intervenha manualmente se necessário.
            </p>
          </div>
        </div>
      )}
